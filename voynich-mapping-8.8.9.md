...
**EVA → Hebräisch-Aramäisch · Version 8.8.9 · Juni 2026**
...
| cheol | ח-ע-ל | schöpfen / heben _(balneologisch)_ | — | — | f2v P.8 (H/F/U 3/4, Erstbeleg) | R2, R43 | ★★★★★ |
| chey | חֵי | lebendig / am Leben | Hebräisch | — | f1r P3.20 (H/C/F/N/X/U 6/6, Erstbeleg) | R19, R40, R43 | ★★★★★ |
| chod | חֹד | Schärfe / Akutheit _(medizinisch)_ | — | — | f18v P.7 (H/C/F/U 4/4, Erstbeleg) | R2, R43 | ★★★ |
| chok | חֹק | Satzung / Vorschrift / Rezepturregel | Mischna-Hebräisch | — | f1r P4.27 (H/C/F/N/X/U 6/6, Erstbeleg) | R2, R40, R43 | ★★★ |
| chom | חֹם | Wärme / Hitze → Schwesterform: cham | Mischna-Hebräisch | — | f3r P.7 (H/C/F 3/3, Erstbeleg) | R2, R40, R43 | ★★★★ |
| chor | חֹר | Pupille / Höhle / Loch | Mischna-Hebräisch | — | f1r P3.20 (H/C/F/N/X/U 6/6, Erstbeleg) | R2, R15, R19, R40, R43 | ★★★★★ |
| chy | חַי | lebendig / am Leben → Vokalvariante: chey | Hebräisch | — | f1v P.6 (H/F 2/3, Erstbeleg) | R19, R40, R43 | ★★★★★ |
...
| dam | דָּם | Blut | Mischna-Hebräisch | ja | f1v P.4 (H/C/F 3/3, Erstbeleg) | R19, R40, R43 | ★★★★★ |
...
| kar | כָּרָה | graben / untersuchen _(medizinisch)_ | Mischna-Hebräisch | — | f6r P.2 (H/C/F 3/3, Erstbeleg) | R40, R43 | ★★★★ |
...
| shol | שׁוֹל | Tod / Unterwelt → Kurzform: sheol | Jüdisch-Aramäisch (Sprache A) | — | f1r P1.1 (H/C/U 3/5, Erstbeleg) | R2, R19, R40, R43 | ★★★★★ |
| shor | שׁוּר | Blick / Reihe / Ochse | Aramäisch / Hebräisch | — | f1v P.9 (H/C/F 3/3, Erstbeleg) | R2, R15, R19, R43 | ★★★★★ |
| tal | טַל | Tau / Pflanzensaft / Feuchtigkeit _(CAULIS-Marker)_ | Hebräisch | — | f13v P.9 (H/C 2/3, Erstbeleg) | R14, R40, R43 | ★★★ |
...
| ckhol | ck- + hol | כְּכֹּל | vollständig wie alles _(Intensiv)_ | f3v P.1 (H/C/D/F/U 5/5, Erstbeleg), f8r P3.15 (H/C/F 3/3), f25v P.4 (H/C/F 3/3), f52v, f53v, f54r, f58r, f99r | R2, R41, R43 | ★★★★ |
| cphar | k- + par | כְּפַּר | Sühne / Bedeckung | f11v P.1 (H/C/U 3/4, Erstbeleg), f36v P.1 (H/C/F 3/3) | R41, R43 | ★★★ |
| cphor | k- + p- + or | כְּפְּאֹר | wie der Mund des Lichts | f3v P.1 (H/C/F/U 4/5, Erstbeleg), f17r P.5 (H/C/F/U 4/4), f32v P.7 (H/F/U 3/4), f36r, f45v, f115v | R2, R41, R43 | ★★★★ |
| cphoy | k- + p- + cho | כְּפְּהוֹ | wie sein Atemweg / wie sein Mund | f1r P2.7 (H/N/U 3/5, Erstbeleg), f18v P.8 (H/C/F/U 4/4) | R2, R41, R43 | ★★★ |
| cthaiin | k- + t- + aiin | כְּתַּעַיִן | vollständige Augen-Heilung | f6r (P.5, P.6, Erstbeleg), f8v P.8 (H/F/U 3/4), f10r P.6 (H/C/F 3/3), f15r, f18r, f20v, f32v, f35r, f42r, f47r | R8, R41, R43 | ★★★★★ |
...
| teor | t- + or | תְּאוֹר | sie wird heilen | f14r P.12 (H/F 2/3, Erstbeleg), f32v P.2 (H/F/U 3/4), f42v P.13 (H/C/F 3/3), f103v | R2, R41, R43 | ★★★ |
| tsho | t- + sho | תְּשׁוֹ | sie entfernt sich von Scheol | f21v P.6 (H/C/F/U 4/4, Erstbeleg), f28v P2.7 (H/C/F/U 4/4), f44v P.1 (H/C/F 3/3) | R2, R41, R43 | ★★★ |
| tshol | t- + shol | תְּשׁוֹל | sie entfernt von Scheol → Vollform: tsho | f23r P.6 (H/C/F 3/3, Erstbeleg), f23v P.6 (H/C/F/U 4/4), f50r P.3 (H/C/F/G/U 5/5), f99r | R2, R41, R43 | ★★★ |
...
| EVA | Morph. | Hebräisch | Deutsch | Evidenz | Regeln | Konf. |
| --- | --- | --- | --- | --- | --- | --- |
| daid | d- + ai + d- | דַּאִידַּ | ? / dauerhaft ≈ | f24v P.7 (H/C/F/U 4/4, Erstbeleg) | R41 | ★★ (R43 Kandidat) |
| dainod | d- + aiin + od | דַּאִיןעֹד | er behandelt das Auge weiter | f16r T1.4 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| dairam | d- + ir + am | דְּאִיראָם | von dem Leuchtenden aller | f50v P.7 (C/F 2/3, Erstbeleg) | R41 | ★★ (R43 Kandidat) |
| dait | d- + ʿet | דַּעִת | von/aus der Zeit / im Moment _(temporal)_ | — | R41 | ★ (R43 Kandidat) |
| dchar | d- + kar | דְּכַּר | vom Widder / männlich _(Zutaten)_ | f28r P.2 (H/C/F 3/3, Erstbeleg) | R41, R45 | ★★ (R43 Kandidat) |
...
| dsholdy | d- + shol + -dy | דְּשׁוֹלדִּי | von Scheol | f9r P.5 (H/C 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| chykar | k- + hey + kar | כְּהֵיכַּר | Blässe-Kraft ≈ _(Zutaten)_ | f29v P.10 (H/C/F/U 4/4, Erstbeleg) | R41 | ★★ (R43 Kandidat) |
...
| cthodoaly | k- + t- + ody + al + -y | כְּ+תְּ+עוֹד+עַל+יְ | wie noch weiter darüber → Intensivform: chodaly | f3v P.9 (H/C/F/U 4/4, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| cthorchy | k- + t- + or + k- + chy | כְּתְּאוֹרכְּהִי | vollständige Heilung der Blässe | f30r P.7 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| kcham | k- + cham | כְּ+חַם | wie Wärme / Entzündung → Variante: kchom | f3v P.12 (H/C/F/U 4/4, Erstbeleg) | R40, R41 | ★★★ (R43 Kandidat) |
...
| koaiin | k- + oaiin | כְּ+עַיִן | wie das Auge → Variante: kaiin | f3v P.1 (H/C/D/F/U 5/5, Erstbeleg) | R2, R8, R41 | ★★ (R43 Kandidat) |
| koshet | k- + she + t- | כֹּשֵׁתְּ | Scheol-Vollständigkeit _(Schlussformel)_ | f16v P.3 (H/F 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| oeeen | o- + een | עַאֵין | auf das Fehlen / Nichts _(Emphase)_ | f14r P.12 (H/F 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| oekor | o- + e- + qor | עַאֵקֹר | auf die Kälte / das Uprooting | f17v P.6 (H/F 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| okchan | o- + k- + chan | עַכְּחָן | auf / für die Gnade _(Prognose)_ | f32v P.6 (H/C/F 3/4, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| okchod | o- + k- + chod | עַכְּחֹד | auf die Schärfe / Akutheit _(medizinisch)_ | f57v R3.1 (V/U 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| okeodaly | o- + k- + ol + dal | עַכֵּעֹדַּל | auf dem Weg des Schwachen | — | R2, R41 | ★ (R43 Kandidat) |
| okorory | o- + k- + or + or + -y | עַכְּאוֹראוֹרִי | auf das Licht / mein Licht | f13r P.10 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| okytaiin | o- + k- + t- + aiin | עַכְּתָּעַיִן | auf die Weise, dass er das Auge heilt | f16v P.11 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| opchor | o- + p- + chor | עַפְּחֹר | auf die Pupille _(medizinisch)_ | f13r P.1 (H/C 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| otoaiin | o- + oto- + aiin | עַתוֹעַיִן | auf seine Augen | f1v P.5 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| tshdar | t- + sh- + d- + ar | תְּשׁדָּאַר | Jahreszeit-Zeichen → Variante: torshor | f33r P.1 (H/C/F 3/3, Erstbeleg) | R41 | ★★ (R43 Kandidat) |
...
| ycheol | y- + k- + eol | יְכְּאֵוֹל | er wird wie Scheol-Licht sein _(ambivalent)_ | f24v P.7 (H/C/F/U 4/4, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
| ychody | y- + k- + dy | יְכֹּדִּי | er wird urteilen → Variante: ytchody | f30r P.2 (H/F 2/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| ysho | y- + sho | יְשׁוֹ | es führt zum Tod | f38r P.6 (H/C/F 3/3, Erstbeleg) | R2, R41 | ★★ (R43 Kandidat) |
...
| ytcheear | y- + t- + k- + e + ar | יְ+תְּ+כְּ+אֵ+אָר | er wird sein wie Heilung durch Licht | f3v P.9 (H/C/F 3/4, Erstbeleg) | R28, R41 | ★★ (R43 Kandidat) |
...
| yteam | y- + t- + eam | יְ+תְּ+אָם | er wird das Volk behandeln | f3v P.14 (H/F/U 3/4, Erstbeleg) | R28, R41 | ★★ (R43 Kandidat) |
| yteechy | y- + chy | יִחְיֶה | er wird gesund | — | R41 | ★ (R43 Kandidat) |
| ytom | y- + tom | יְתָּם | er wird vollständig / komplett | — | R2, R41 | ★ (R43 Kandidat) |
...
| daiidy | daii + -dy | דַּיִּדִּי | dessen Urteil → Variante: daiindy | f3v P.2 (H/C/F/U 4/5, Erstbeleg) | — | ★★ (R43 Kandidat) |
...
| dala | dal + -a | דַּלָּ | Schwäche → Femininum: dal | f14r P.5 (H/F 2/3, Erstbeleg) | — | ★★ (R43 Kandidat) |
...
| chodl | chodl (Part. von חדל) | חֹדֵל | der Aufhörende / der Sterbende | f11r P.5 (H/C/F 3/3, Erstbeleg) | R2 | ★★ (R43 Kandidat) |
...
| dydyd | dy + dy + dy | דִּידִּידִּי | dreifacher Relativpartikel _(Emphase)_ | f1r P3.17 (H/F/U 3/5, Erstbeleg) | R25 | ★★ (R43 Kandidat) |
| keeees | keeees | ??? | Hapax ≈ _(Hapax)_ | f21v P.3 (H/C/F/U 4/4, Erstbeleg) | — | ★★ (R43 Kandidat) |
...
| shodain | shod + d- + aiin | שׁוֹדדַּעַיִן | Zerstörung des Auges _(Diagnose)_ | f1r P3.12 (H/C/F/N/U 5/5, Erstbeleg) | R2, R40, R41 | ★★★ (R43 Kandidat) |
...
57 Regeln gesamt: **40 validiert** (≥ 2 unabhängige Belege) + **17 Kandidaten**. **Regelmoratorium beendet (v8.8.9)** — Verhältnis 40:17 = 2,35:1 ≥ 1,5:1. R60+ freigegeben. R2-ext (v7.5): explizite o-Positionsregel mit Negativtest. R14 und R20 gesichert (★★★★★).
...
| R40 | **Kurzwurzel-Konfidenzdeckel v2** — Basiswurzel ≤ 3 Konsonanten nach Präfix-/Suffix-Abzug → max. ★★Ausnahmen (mind. 2 müssen erfüllt sein):(a) Funktionswort ≤ 3 EVA-Zeichen gesamt (Konj./Präp./Artikel/Partikel)(b) Rückwärtstest-Anker (derzeit 23 Anker)(c) Korpusfrequenz ≥ 15× in ≥ 3 Folios mit sem. konsistentem Kontext**HARD CAP ★★** bei < 2 erfüllten Bedingungen**Klausel (d) — GibberishTest-Protokoll (GPA-1):** Generierte Pseudowörter mit ≥ 1 Stolfi-Corpus-Treffer (beliebiges Folio) gelten als _versehentlich echte Corpus-Tokens_ und werden vor Testauswertung verworfen — Ersatz-Token generieren, bis genuines Hapax (0 Corpus-Belege) vorliegt. Hintergrund: Voynich-like Bigramm-Sampling reproduziert mit ~12–15 % Wahrscheinlichkeit Hochfrequenz-Tokens (daiin, chor, or, shol u. a.); deren korrekte ★★★+-Bewertung ist kein Framework-Fehlalarm, sondern ein Sampler-Artefakt. | or → ★★★★ bleibt (b ✓ + c ✓: 52×, 5 Folios); chor → ★★★★ bleibt (b ✓ + c ✓: 47×, 5 Folios); daiin → ★★★★ bleibt (b ✓ + c ✓: 38×, 5 Folios); shol → ★★★ bleibt (b ✓ + c ✓: 19×, 5 Folios); ky → ★★★ bleibt (a ✓ + b ✓); dy → ★★ (a nur 1/2 — zu lang für Grenzfall); v8.8.9 GibberishTest-Diagnose: 16,4 % ★★★+-Rate — davon 75,6 % (62/82 Treffer, 10 Läufe) LEX-Treffer auf echte Corpus-Tokens; nach GPA-1-Protokoll erwartete Residualrate: ~4,0 % (R40-Ausnahme-Pfad) → Zielkorridor ≤ 10 % ✓ | ★★★ |
