...
<p>{RULES.length} Regeln gesamt: <strong>24 validiert</strong> (≥ 2 unabhängige Belege) + <strong>{RULES.length - 24} Kandidaten</strong> (darunter v6.2 R40–R42, D1/D2; v6.3 R43–R44; v6.4 R45–R48; v6.5 R33-Erweiterung + R49). R14 und R20 gelten als gesichert (★★★★★). Regeln mit ⚠ im Titel sind Warnsignale ohne automatische Konfidenzreduktion.</p>
