export const STEM_WORDS = [
  ...
  { eva: "sho",     heb: "שׁוֹ",        de: "Scheol-Gleichheitspartikel",                           layer: "Jüdisch-Aramäisch",                     isAnchor: false,  anchorFolio: "f3r P.9 (H/C/F 3/3) + f3v P.11 (H/C/F/U 4/4)", confidenceStars: 3, candidate: false, rulesApplied: [] },
...
export const PREF_K = [
  ...
  { eva: "cthy",      morph: "c- + t- + hy",            heb: "כְּ+תִי",      de: "wie mein Zeichen / wie diese [Form]",                evidence: "f3r P.3+P.19 (H/C/F) + f3v P.9 (H/C/F/U 4/4)",                        confidenceStars: 3, candidate: false, rulesApplied: [] },
