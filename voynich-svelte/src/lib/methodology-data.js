export const CONFIDENCE_SCALE = [
  { stars: '★★★★★',    label: 'Gesichert',         criteria: '≥ 10 Folios Mehrheitskonsens, 0 Gegenbeispiele, R43 erfüllt' },
  { stars: '★★★★',      label: 'Sehr stark',        criteria: 'Rückwärtstest ✓ (Typ-I Anker) oder R43 erfüllt + ≥ 5 Folios Mehrheitskonsens' },
  { stars: '★★★',        label: 'Stark',             criteria: 'Semantisch kohärent, morphologisch konsistent, Basiswurzel ≥ 4 Konsonanten (R40 v2), R43 erfüllt' },
  { stars: '★★★ Kand.',  label: 'Stark-Kandidat',    criteria: 'R40 erfüllt (Basiswurzel ≥ 4 Konsonanten) + R41 (Präfixstruktur), R43 ausstehend' },
